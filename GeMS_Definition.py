...
# SCGS EDITS BY DARBY DEBRUHL
# 8 June 2021: "StationsBoreholeLogs" (line 279) optional nonspatial table has been defined.
# 8 June 2021: "Stations" optional feature class (line 152) has had optional fields appended and defined.
		...
		'OrientationPoints':   [['Type','String','NoNulls',defaultLength],
		   ...
		   'Stations':         [['FieldID','String','NoNulls',IDLength],
					...
					['SignificantDimensionMeters','Single','NullsOK'],
                                        ## 06/2021: New fields start here
                                        ['ElevationMeters','Single','NullsOK'],
                                        ['LocationDescription','String','NullsOK',500],
                                        ['LoggedBy','String','NullsOK',50],
                                        ['County','String','NullsOK',50],
                                        ['DrilledBy','String','NullsOK',50],
                                        ['Helpers','String','NullsOK',50],
                                        ['SampleID','String','NullsOK',50],
                                        ['Photo','String','NullsOK',50],
                                        ['Method','String','NullsOK',100],
                                        ## New fields end here
					['GPSX','Double','NoNulls'],
					['GPSY','Double','NoNulls'],  
					['PDOP','Single','NullsOK'],
...
# optional feature classes not described in GeMS specification               
		...
		'PhotoPoints':         [['Type','String','NoNulls',defaultLength],
					...
					['Notes','String','NullsOK',defaultLength]],
               ## 06/2021: New table starts here ##
             'StationsBoreholeLogs':    [['FieldID','String','NoNulls',50],
                                        ['TopContactDepth_ft','Single','NoNulls',defaultLength],
                                        ['TopContactDepth_m','Single','NoNulls',defaultLength],
                                        ['BottomContactDepth_ft','Single','NoNulls',defaultLength],
                                        ['BottomContactDepth_m','Single','NoNulls',defaultLength],
                                        ['TopContactElevation_ft','Single','NoNulls',defaultLength],
                                        ['TopContactElevation_m','Single','NoNulls',defaultLength],
                                        ['BottomContactElevation_ft','Single','NoNulls',defaultLength],
                                        ['BottomContactElevation_m','Single','NoNulls',defaultLength],
                                        ['BoreholeUnitThickness_ft','Single','NoNulls',defaultLength],
                                        ['BoreholeUnitThickness_m','Single','NoNulls',defaultLength],
                                        ['BoreholeUnit','String','NoNulls',100],
                                        ['Description','String','NoNulls',2500],
                                        ['IdentityConfidence','String','NoNulls',50],
                                        ['DataSourceID','String','NoNulls',50],
                                        ['StationsBoreholeLogs_ID','String','NoNulls',50]]
               ## New table ends here ##
}
