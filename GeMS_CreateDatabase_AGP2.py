...
# 8 June 2021: Added reference to new nonspatial table "StationsBoreholeLogs" (line 257), which GeMS_Definitions.py has been modified to define.
# 8 June 2021: References to "Stations" feature class (line 189) remain the same, but addtl fields have been added to its definition in GeMS_Definitions.py.
...
I agree - 
    ...
    # create tables
    # 6/8/2021 added 'StationsBoreholeLogs'
    tables = ['DescriptionOfMapUnits','DataSources','Glossary']
    for tb in ['RepurposedSymbols','StandardLithology','GeologicEvents','MiscellaneousMapInformation','StationsBoreholeLogs']:
